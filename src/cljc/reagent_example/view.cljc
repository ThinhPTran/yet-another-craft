...
(defn entity [id data current-user
  ...
  (let [width (-> data :size :x)
    ...
    [:div.entity {:style {:width width, :height height, :left x, :top y}}
     ...
     [commands-list id commands selected command]
...
(defn entities [attack select command
...
(defn game-page [move attack select command
